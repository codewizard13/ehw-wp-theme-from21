...
function twenty_twenty_one_add_sub_menu_toggle( $output, $item, $depth, $args ) {
	if ( 'primary' === $args->theme_location
		...
		// Add toggle button.
		$output .= '<button class="sub-menu-toggle" aria-expanded="false" onClick="from21ExpandSubMenu(this)">';
		...
		$output .= '<span class="screen-reader-text">' . esc_html__( 'Open menu', 'from21' ) . '</span>';
		$output .= '</button>';
	}
	return $output;
}
