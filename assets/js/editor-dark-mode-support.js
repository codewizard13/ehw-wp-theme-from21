/* global from21IsDarkMode, setTimeout */

// Check the color scheme preference and inject the classes if necessary.
if ( document.body.classList.contains( 'from21-supports-dark-theme' ) ) {
	from21DarkModeEditorInit();
}
 ...
 * @return {void}
 */
function from21DarkModeEditorInit( attempt ) {
	...
	if ( from21IsDarkMode() ) {
		if ( null === container ) {
			...
			if ( attempt < maxAttempts ) {
				setTimeout(
					function() {
						from21DarkModeEditorInit( attempt + 1 );
					},
