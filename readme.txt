...
From21 is a blank canvas for your ideas and it makes the block editor your best brush.
...
Take it for a spin! See how From21 elevates your portfolio, business website, or personal blog.

== Installation ==

1. In your admin panel, go to Appearance -> Themes and click the 'Add' button.
2. Type in From21 in the search form and press the 'Enter' key on your keyboard.
...
== Privacy ==
From21 uses LocalStorage to save the setting when Dark Mode support is turned on or off.
...
From21 WordPress Theme, 2020-2025 WordPress.org and contributors.
From21 is distributed under the terms of the GNU GPL.
...
From21 is derived from Seedlet, (C) 2020 Automattic, Inc.

From21 is also based on:
